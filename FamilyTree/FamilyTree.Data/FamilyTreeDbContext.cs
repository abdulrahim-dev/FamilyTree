...
namespace FamilyTree.Data
{
    public class FamilyTreeDbContext : IdentityDbContext<ApplicationUser>, IDbContext
    {
        ...
        public FamilyTreeDbContext()
            : base("FamilyTreeDbConnection")
        {

        }

        public FamilyTreeDbContext(string nameOrConnectionString, ILogger logger)
        ...
        {
            return new FamilyTreeDbContext(nameOrConnectionString: "FamilyTreeDbConnection", logger: null);
        }
